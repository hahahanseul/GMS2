...
public class SQL {
	...
	public static final String STUDENT_LIST=String.format("SELECT %s,%s,%s,%s,%s,%s,%s,%s FROM %s", DB.NUM,DB.ID,DB.MEMBER_NAME, DB.MEMBER_SSN,DB.MEMBER_REGDATE,DB.PHONE,DB.EMAIL,DB.TITLE,DB.TABLE_STUDENT);
}
